...
def main():
    """
    Welcome! \U0001F4DA This simple CLI app for querying Google Books was build by Brady Gerber with the Click python package. In your terminal, please type out "python3 books.py" and one of the below commands and then press Enter (EX: "python3 books.py view" or "python3 books.py search harry-potter 10").\n
    ...
    To exit your search early, use "ctrl + c."\n
    Happy reading!\n
    -B
    """
    pass
...
def search(user_search, max_results):
    ...
    # Start a search with no books in it that we'll populate soon; combine_dict will be temporary for each search.
    combine_dict = []
    ...
    # ... And we confirm the book that user selects from our temporary "combine_dict".
    user_selection = combine_dict[user_pick-1]
    click.echo(f'Great! You picked No. {user_pick}: "{user_selection["TITLE"]}"')
    click.echo('')

    # If we find duplicates in our txt file in our choice, exit out of script ...
    ...
    # ... And then we append that selection to our reading list file ...
    ...
    # ... And then we confirm that the add was successful!
